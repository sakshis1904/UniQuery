    ...
    <div className="min-h-screen py-10 px-4 flex justify-center items-center" style={{ backgroundColor: "#E6E6FA" }}>
      <div className="flex gap-8 w-full max-w-6xl">
        ...
        <div className="w-1/4 p-6 rounded-lg shadow-md text-gray-700" style={{ backgroundColor: "#F0E6F0" }}>
          <p onClick={() => navigate('/my-profile')} className="mb-3 font-medium cursor-pointer">My Profile</p>
        ...
        <form onSubmit={handleSubmit} className="bg-white px-8 py-10 border rounded-lg w-full" >
          <h2 className="text-2xl font-semibold text-center mb-6" style={{ color: "#452c63" }}>
            Report a Wi-Fi Connectivity Issue
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-600">
            ...
            <div className="md:col-span-2">
               <p>Type  of Wi-fi Issue</p>
               <select name="type"  onChange={handleChange} value={formData.type}className="border rounded px-3 py-2 w-full" required>
                  <option value="Access">No internet access</option>
                  <option value="Speed">Very Slow Speed</option>
                  <option value="Disconnect">Wifi disconnnecting frequently</option>
                  <option value="Network">Unable to connect to network</option>
                  <option value="Register">Device not registered</option>
                </select>
            </div>

            <div>
               <p>Preferred Date</p>
               <input type="date" name="date" value={formData.preferredDate} onChange={handleChange} placeholder="Preferred Day" className="border rounded px-3 py-2 w-full" />
            </div>
        ...
        <div>
            ...
            🛠 Wi-Fi issues are attended during 9:30 AM – 5:30 PM, Monday to Saturday.<br/>
