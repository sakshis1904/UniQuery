        ...
        <form onSubmit={handleSubmit} className="bg-white px-8 py-10 border rounded-lg w-full" >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-600">
            ...
            <div className="md:col-span-2">
               <p>Type of Housekeeping Issue</p>
               <select name="type"  onChange={handleChange} value={formData.time}className="border rounded px-3 py-2 w-full" required>
                  <option value="Room">Room Not Cleaned </option>
                  <option value="Staff">Cleaning Staff Not Visiting</option>
                  <option value="Dustbin">Dustbin Not Emptied</option>
                  <option value="Corridor">Dirty Corridors</option>
                  <option value="Area">Unclean Common Area</option>
                </select>
            </div>

            <div>
               <p>Preferred Date</p>
               <input type="date" name="preferredDate" value={formData.preferredDate} onChange={handleChange} placeholder="Preferred Day" className="border rounded px-3 py-2 w-full" />
            </div>
