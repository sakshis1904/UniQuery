      ...
      <div className="flex gap-8 w-full max-w-6xl">
        ...
        <form onSubmit={handleSubmit} className="bg-white px-8 py-10 border rounded-lg w-full" >
          <h2 className="text-2xl font-semibold text-center mb-6" style={{ color: "#452c63" }}>
            Report a Laundry Service Issue
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-600">
            ...
            <div className="md:col-span-2">
               <p>Type  of Laundry Issue</p>
               <select name="type"  onChange={handleChange} value={formData.time}className="border rounded px-3 py-2 w-full" required>
                  <option value="Pick">Clothes Not Picked</option>
                  <option value="Miss">Clothes Missing</option>
                  <option value="Damage">Clothes Damaged</option>
                  <option value="Umwash">Unwashed Clothes Returned</option>
        ...
        <div>
            ...
            🛠 Laundry service is active from 9 AM – 6 PM, Monday to Saturday. <br/>
            Attach a photo if clothes were damaged.<br/>
            Report missing clothes within 24 hours of delivery.
          </p>
        </div>
