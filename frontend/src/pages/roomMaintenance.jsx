      ...
      <div className="flex gap-8 w-full max-w-6xl">
        ...
        <form onSubmit={handleSubmit} className="bg-white px-8 py-10 border rounded-lg w-full" >
          <h2 className="text-2xl font-semibold text-center mb-6" style={{ color: "#452c63" }}>
            Raise a Room Maintenance Request
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-600">
            ...
            <div className="md:col-span-2">
               ...
               <textarea name="issue" value={formData.issue} onChange={handleChange} placeholder="Describe the issue" className="border rounded px-3 py-2 w-full" required></textarea>
            </div>
        ...
        <div>
            ...
            🛠 Carpenter visits are available between 10 AM to 6 PM on working days only.<br />
            For urgent issues (e.g., water leakage, power outage), call the warden directly.<br />
