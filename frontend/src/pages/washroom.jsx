    ...
    <div className="min-h-screen py-10 px-4 flex justify-center items-center" style={{ backgroundColor: "#E6E6FA" }}>
      <div className="flex gap-8 w-full max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-600">
            ...
            <div className="md:col-span-2">
               ...
               <select name="type"  onChange={handleChange} value={formData.time}className="border rounded px-3 py-2 w-full" required>
                  ...
                  <option value="Work">Flush Not Working</option>
                  <option value="Taps">Broken Taps</option>
                  <option value="Dirty">Dirty Washroom</option>
        ...
        <div>
            ...
            🛠 Washroom issues are prioritized based on severity.<br/>
              Repairs are handled during 10 AM – 5 PM.<br/>
