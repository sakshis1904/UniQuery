      ...
      <div className="flex">
        ...
        <div className="w-1/5 bg-white shadow h-screen p-6">
          <ul className="flex flex-col gap-4 text-[#333]">
            ...
            <li onClick={() => navigate('/pending-complaints')} className="text-red-500 font-semibold mb-6">Pending Complaints</li>
          </ul>
        </div>
        ...
        <div className="flex-1 p-10">
          ...
          <div className="bg-white shadow p-6 rounded-lg">
            <p className="text-red-500 font-semibold text-lg mb-4">Pending Complaints</p>
